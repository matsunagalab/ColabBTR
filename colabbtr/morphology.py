...
class BTRLoss(nn.Module):
    def __init__(self, tip_mlp, kernel_size, boundary_weight=1.0, height_constraint_weight=1.0):
        super().__init__()
...
# Usage example
#tip_mlp = TipShapeMLP()
#criterion = BTRLoss(tip_mlp, kernel_size=11, boundary_weight=1.0, height_constraint_weight=1.0)
